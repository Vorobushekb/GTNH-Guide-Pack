...
## Материалы
Когда ты достигнешь технлогического уровня, необходимого для постройки МЭ системы, тебе также понадобяться следующие материалы:
...
<GameScene zoom="5" interactive={true} width="400" height="300">
  ...
  <Color color="#e5e90c">Это отладочный генератор, установленный для демонстрании. Его невозможно получить в выживании. Для нормального использования подключите МЭ сеть к энергосети.</Color>
  </BlockAnnotation>
</GameScene>

МЭ система в этой сцене получент питание от GT энергосети, расположенной слева. Она обеспечивает базовые функции хранения предметов:
...
[Предметы и блоки](items-blocks-index.md)

[Механики AE2](ae2-mechanics-index.md)

[Советы и примеры](tricks-example-index.md)
