...
* Создавайте вашу сеть древовидной(ветвистой) и избегайте зацикливаний.
* Размещайте [устройства](ae2_mechanics/devices.md), занимающие целый блок, группами по 8 или меньше, если вы не обладаете достаточным пониманием того, как [каналы](ae2_mechanics/channels.md) проходят по сети.
* Выберите один вид дерева и палок, используйте его во всех своих [шаблонах](items_blocks/patterns.md). Включение замены в шаблонах иногда помогает, но применение одного вида везде значительно упрощает работу.
